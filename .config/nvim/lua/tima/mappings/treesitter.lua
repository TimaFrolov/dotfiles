local move = function() return require('nvim-treesitter.textobjects.repeatable_move') end

return {
  lazy = {
    { ';', function() return move().repeat_last_move() end,          mode = { 'n', 'x', 'o', } },
    { ',', function() return move().repeat_last_move_opposite() end, mode = { 'n', 'x', 'o', } },
    { 'f', function() return move().builtin_f_expr() end,            mode = { 'n', 'x', 'o', }, expr = true },
    { 'F', function() return move().builtin_F_expr() end,            mode = { 'n', 'x', 'o', }, expr = true },
    { 't', function() return move().builtin_t_expr() end,            mode = { 'n', 'x', 'o', }, expr = true },
    { 'T', function() return move().builtin_T_expr() end,            mode = { 'n', 'x', 'o', }, expr = true },
  },
